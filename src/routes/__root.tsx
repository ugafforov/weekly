...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create sorted weekly student rating reports from Excel for Al-Xorazmiy School." },
      { name: "author", content: "Al-Xorazmiy School" },
      { property: "og:title", content: "Al-Xorazmiy Weekly Rating Dashboard" },
      { property: "og:description", content: "Create polished class rating reports from weekly Excel results." },
